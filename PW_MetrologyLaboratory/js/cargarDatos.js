...
function agregarMaterial() {
    ...
    var newRow = $('<div id="newRow' + indexMaterial + '" class="row row-cols-xl-3 clearfix">'
        ...
        + '</div>'
        + '</div>'
        + '<div class="col-xl-4 text-center row position-absolute" id="imgMaterial' + indexMaterial+'">'
        + '<div class="col">'
        ...
        + '</div>'
        + '</div>'
        + '<div class="col-xl-4 buttons-container position-relative" id="divButtons' + indexMaterial + '">'
