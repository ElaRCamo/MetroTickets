...
function agregarPieza() {
    ...
    var newRow = $('<div id="newRow' + indexMaterial + '" class="row row-cols-xl-3 clearfix">'
        ...
        + '<select id="cliente' + indexMaterial + '" name="cliente" class="form-control" onclick="" onchange="llenarPlataforma(' + indexMaterial + ')" required data-error="Por favor ingresa el area solicitante">'
