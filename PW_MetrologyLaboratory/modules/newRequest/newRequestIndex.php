...
<body>
    ...
    <script type="text/javascript">
        function agregarNumParte() {
            var elementosMaterial = document.getElementById("elementosMaterial");
            var divNuevo = document.createElement("div");
            divNuevo.className = "col-xl-8";
            divNuevo.innerHTML = '<div class="row">'
                + '<div class="col-sm-6">'
                + '<div class="form-group"">'
                + '<div class="help-block with-errors"></div>'
                + '<input name="numPartes[]" type="text" class="form-control" onchange="llenarCliente()" placeholder="Número de parte*" required data-error="Por favor ingresa el número de parte">'
                ...
                + '<select name="clientes[]" class="form-control" onchange="llenarPlataforma()" required data-error="Por favor ingresa el area solicitante">'
                ...
                + '<div class="form-group">'
                + '<div class="help-block with-errors"></div>'
                + '<select name="plataformas[]" class="form-control" onchange="llenarDescMaterial()" required data-error="Por favor ingresa la plataforma">'
                ...
                + '<div class="form-group">'
                + '<div class="help-block with-errors"></div>'
                + '<select name="descripciones[]" class="form-control" onchange="descripcionMaterial()" required data-error="Por favor ingresa la descripción del material">'
                ...
                + '<div class="form-group">'
                + '<div class="help-block with-errors"></div>'
                + '<input name="cdadesMaterial[]" type="number" class="form-control" placeholder="Cantidad*" required data-error="Por favor ingresa la cantidad">'
                + '<div class="input-group-icon"><i class="las la-cog"></i></div>'
                + '</div>'
                + '</div>'
                + '</div>';
            elementosMaterial.appendChild(divNuevo);
        }
    </script>
