                                    ...
                                    <form name="formNewRequest" action="" method="POST" enctype="multipart/form-data" id="formRequestLab" data-toggle="validator" class="popup-form">
                                        <div class="row">
                                            <div class="form-group col-sm-6" id="selectEvaluacion">
                                                ...
                                                <select class="form-control" id="tipoEvaluacion" onchange="banderaTipoEvaluacion(); llenarEvaluacion();" name="tiposEvaluaciones" title="TipoDeEvaluacion" required data-error="Por favor seleccione tipo de evaluacion" >
