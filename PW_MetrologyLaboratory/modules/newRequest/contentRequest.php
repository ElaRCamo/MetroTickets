                                        ...
                                        <div class="row" id="contenedorFormulario">
                                            ...
                                            <div class="col-sm-4" id="selectTipoPrueba">
                                                ...
                                                <div class="form-group">
                                                    <select class="form-control" id="tipoPrueba" onchange="banderaTipoPrueba(); llenarCliente(1); initTooltipModMate(); initTooltipRevDibujo();" name="tiposPrueba" title="TipoDePrueba" required data-error="Por favor seleccione un tipo de prueba válido.">
