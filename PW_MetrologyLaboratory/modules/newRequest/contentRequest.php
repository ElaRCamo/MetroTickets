                                    ...
                                    <form name="formNewRequest" action="" method="POST" enctype="multipart/form-data" id="formRequestLab" data-toggle="validator" class="popup-form">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-sm-6" id="normaNombre">
                                                <div class="help-block with-errors"></div>
                                                <input type="text" class="form-control" id="norma" onchange="llenarPruebaEspecial(); ocultarOpcion();" placeholder="Norma*" required data-error="Por favor ingresa la norma para realizar la prueba">
