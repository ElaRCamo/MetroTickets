                                            ...
                                            <div class="form-group col-sm-12" id="addPersonalTitle">
                                                <table class="table table-borderless" id="personalTitulo">
                                                    <tr>
                                                        ...
                                                        <td class="tdButton">
                                                            <button type="button" id="addPersonal1" onclick="agregarPersonal()"><i class="las la-plus-square"></i>Agregar</button>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            ...
                                            <div class="form-group col-sm-12" id="agregarNumParte">
                                                <table class="table table-borderless" id="materialesTitulo">
                                                    <tr>
                                                        ...
                                                        <td class="tdButton">
                                                            <button type="button" id="addNumParte1" onclick="agregarPieza()"><i class="las la-plus-square"></i>Agregar pieza</button>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
