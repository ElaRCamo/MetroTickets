                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row justify-content-end">
                        <div class="">
                            ...
                            <button type="button" class="btn btn-secondary" onclick="registrarPlataforma()" data-bs-dismiss="modal"><i class="las la-save"></i>Guardar</button>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-body row">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row justify-content-end">
                        <div class="">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" onclick="">Close</button>
                            <button type="button" class="btn btn-secondary" id="btn-updPlataforma" data-bs-dismiss="modal"><i class="las la-save"></i>Guardar</button>
                        </div>
                    </div>
                </form>
            </div>
